...
pub extern fn glGetUniformLocation(_: c_uint, name: [*:0]const u8) c_int;
...
pub extern fn glVertexAttribPointer(_: c_uint, _: c_uint, _: c_uint, _: c_uint, _: c_uint, _: ?*const anyopaque) void;
...
// Shaders
pub extern fn compileShaderProgram(source: [*:0]const u8, len: c_uint, type: c_uint) c_uint;
